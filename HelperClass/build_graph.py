...
class BuildGraph:
    ...
    def get_node_graph(node: Node, border_color='black', background='white', flag_negation=False):
        ...
        if node.flag_negation:
            background_neg = BuildGraph.inverse_color(background)
    ...
    def _handle_onto_class(class_onto):
        ...
        if len(class_onto.equivalent_class) == 0:
            ...
            for equivalent_class in class_onto.equivalent_class:
        ...
        class_graph = BuildGraph.get_nested_graph(class_graph, 'cluster_' + class_onto.name,
    ...
    def create_graph(self):
        ...
        # inner_elm, graph = BuildGraph._handle_onto_class(self.data[2])
        # graph_main += graph
